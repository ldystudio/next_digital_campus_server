...
class Information(models.Model):
    ...
    service_date = models.DateField(db_comment="入职日期", null=True)
    ...
    identification_number = models.CharField(
        db_comment="身份证件号码", max_length=20, unique=True, null=True
    )
    address = models.CharField(db_comment="地址", max_length=100, null=True)
...
class Work(models.Model):
    ...
    course_name = models.CharField(db_comment="课程名称", max_length=100, null=True)
    course_class = models.CharField(db_comment="课程班级", max_length=50, null=True)
    meeting_name = models.CharField(db_comment="会议名称", max_length=100, null=True)
    location = models.CharField(db_comment="会议地点", max_length=100, null=True)
    work_content = models.TextField(db_comment="工作内容", null=True)
